    ...
    Tables: {
      ...
      form_submissions: {
        Row: {
          ...
          comida_juntos: string | null
          conheceram: string
          created_at: string
          detalhe_fofo: string | null
          hobby_atividade: string | null
          id: string
          lugar_especial: string | null
          momentos_inesqueciveis: string
          musica_comeco: string | null
          nomes: string
          observacoes: string | null
          outros_detalhes: string | null
          pets: string | null
          presente_especial: string | null
          primeira_foto: string | null
          primeira_viagem: string
          primeiro_encontro: string
          restaurante_especial: string | null
          status: string
          telefone: string
          updated_at: string
